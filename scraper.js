...
(async () => {
    ...
    // request for the pagelink as input
    //prompt user for catgory
    // import prompt
    
    


    const pagelink = "https://www.seedsman.com/eu_en/cannabis-seeds/cultivation/grows-indoors"
    ...
    const data = await page.evaluate(() => {
        ...
        const category = "Best Indoor Seeds"
